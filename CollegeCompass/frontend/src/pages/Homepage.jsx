...
{/*          
        <div className="places-container">
          {isLoading ? (
                ...
                <div key={place.fsq_id} className="places-box">
                  {place.photos && place.photos.length > 0 ? (
                    <div className="place-image-container">
                      <img
                        src={`${place.photos[0].prefix}300x200${place.photos[0].suffix}`}
                        alt={place.name}
              ...
              return (
                <div key={place.fsq_id} className="places-box housing-box">
                  {place.photos && place.photos.length > 0 ? (
                    <div className="place-image-container">
                      <img
                        src={`${place.photos[0].prefix}300x150${place.photos[0].suffix}`}
                        alt={place.name}
                        className="place-image"
                      />
                    </div>
            ...
            <p>Click "Food" or "Housing" to see nearby places.</p>
          )}
        </div>  */}

        {/* Display places with address and categories without images  */}
        ...
        {/* <div className="places-container">
          {isLoading ? (
          ...
          ) : housingPlaces.length > 0 ? (
            housingPlaces.map((place) => (
              <div key={place.fsq_id} className="places-box">
                <h3>{place.name}</h3>
                <p>{place.location.address || "Address not available"}</p>
                {place.categories && place.categories[0] && (
            ...
            <p>Click a category to see nearby places.</p>
          )}
        </div> */}
